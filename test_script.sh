...
for gene in "${genes[@]}"; do
    ...
    sed '/^>/! s/[X-*!]//g' ./for_alignment_aa/for_alignment_${gene}_temp2.fa > ./for_alignment_aa/for_alignment_${gene}.fa
...
sed '/^>/! s/[N-*!]//g' ./for_alignment_nt/for_alignment_whole_temp2.fa > ./for_alignment_nt/for_alignment_whole.fa
